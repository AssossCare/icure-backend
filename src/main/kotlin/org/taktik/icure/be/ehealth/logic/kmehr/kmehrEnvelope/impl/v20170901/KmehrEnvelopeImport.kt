...
@org.springframework.stereotype.Service("kmehrEnvelopeImport")
class KmehrEnvelopeImport(val patientLogic: PatientLogic,
    ...
    fun importKmehrEnvelope(inputStream: InputStream,
                     author: User,
                     language: String,
